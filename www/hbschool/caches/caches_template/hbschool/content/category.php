...
<div id="colee2"></div>
        ...
        <div id="right">
        	<h1><?php echo $catname;?></h1>
            <ul>
            	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=4df45ebabb35a3eecd25e93a3e86e572&action=lists&catid=%24catid&order=inputtime+DESC&num=20\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>$catid,'order'=>'inputtime DESC','limit'=>'20',));}?>
            		<?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>
